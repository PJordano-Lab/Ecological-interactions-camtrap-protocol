...
In this code we group eating events every 5 miutes from the eating_effort data that we just created above . 
...
Fonally calculate the intensity of the interaction using the number of intervals as a proxy for time spent interacting. The intensity is calculated as the square root of the number of intervals.
